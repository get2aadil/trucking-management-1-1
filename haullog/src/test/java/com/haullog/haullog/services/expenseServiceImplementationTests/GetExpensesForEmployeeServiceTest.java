...
@SpringBootTest
public class GetExpensesForEmployeeServiceTest {
	@Mock
    ...
    @Test
    public void testGetExpenseByEmployeeServiceSuccess() {
    	...
    	when(expenseRepository.findByEmployeeId(101)).thenReturn(Optional.of(expenses));
    	
    	List<Expense> response = expenseServiceImplementation.getExpensesForEmployee(101);
